<template>
  <div class="page-container">
    ...
    <el-card style="margin-top: 12px;" header="出库明细">
      <el-table :data="tableData" v-loading="loading" stripe border>
        <el-table-column prop="date" label="日期" width="120" />
        <el-table-column prop="orderCount" label="出库单数" width="100" align="right" />
        <el-table-column prop="totalQuantity" label="出库数量" width="120" align="right" />
        <el-table-column prop="totalAmount" label="出库金额" width="130" align="right">
...
import { getOutboundStats } from '@/api'
...
const renderChart = () => {
  ...
  chart.setOption({
    ...
    series: [
      { name: '出库数量', type: 'bar', data: quantities, itemStyle: { color: '#f56c6c' } },
      { name: '出库金额', type: 'line', yAxisIndex: 1, smooth: true, data: amounts, itemStyle: { color: '#e6a23c' } },
    ],
  })
}
