<template>
  <div class="page-container">
    ...
    <el-dialog v-model="dialogVisible" :title="form.id ? '编辑物资' : '新增物资'" width="600px" destroy-on-close>
...
import { getMaterialList, saveMaterial, updateMaterial, deleteMaterial, getAllCategories } from '@/api'
